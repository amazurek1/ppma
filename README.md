...
<br>
<br>The goal of the paper (link) and the models developed at Boehringer Ingelheim is to predict the percent monomer of a given multispecific antibody. This prediction is based on the sequence, germline, and format information associated with each antibody.
